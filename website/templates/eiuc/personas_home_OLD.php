	...
	<div class="recensione_verticale">
		...
		<div class="quote_sinistra recensione_gc_europe quote_europe z_index">
			<img src="files/eiuc/Marcel_Van_Maastrigt.jpg" alt="Marcel Van Maastrigt" class="cerchio_img">
			<img src="files/eiuc/virgolette_bianche.svg" alt="virgolette" class="margin_bottom_20">
			<p class="testo_quote">EMA, through its broad approach, prepared me further for diverse positions, from a temporary post at the UNHCHR office in Geneva to various field functions with UNHCR.
			</p>
			<p class="name_quote">Marcel Van Maastrigt</p>
			<p class="margin_bottom_20">The Netherlands</p>
		...
		<div class="quote_sinistra recensione_gc_arab quote_arab z_index">
			<img src="files/eiuc/haneen_new.png" alt="Haneen Mraiyan" class="cerchio_img">
			<img src="files/eiuc/virgolette_bianche.svg" alt="virgolette" class="margin_bottom_20">
			<p class="testo_quote">A place where people with the most diverse professional and cultural background can come and work together on creating a better world.
			</p>
			<p class="name_quote">Haneen Mraiyan</p>
			<p class="margin_bottom_20">Jordan</p>
			<div class="programma_persona">
		...
		<!-- quote latin america -->
		<div class="quote_sinistra recensione_gc_latin_america quote_america z_index">
			<img src="files/eiuc/diana.png" alt="immagine pedro gonzales" class="cerchio_img">
			<img src="files/eiuc/virgolette_bianche.svg" alt="virgolette" class="margin_bottom_20">
			<p class="testo_quote">A place where people with the most diverse professional and cultural background can come and work together on creating a better world.
			</p>
			<p class="name_quote">Diana Lorena Obagi Garcia</p>
			<p class="margin_bottom_20">Colombia</p>
			<div class="programma_persona">
				<img src="files/eiuc/icona_gc_latin_america_bianca.svg" alt="icona gc latin america" class="icona_programma_persona">
				<p class="title_programma_persona ">GC Latin America - Caribbean</p>
			</div>
		</div>
		
		<!-- quote caucasus -->
		<div class="quote_sinistra recensione_gc_africa quote_africa z_index">
			<img src="files/eiuc/adebayo.png" alt="Adebayo Okeowo" class="cerchio_img">
			<img src="files/eiuc/virgolette_bianche.svg" alt="virgolette" class="margin_bottom_20">
			<p class="testo_quote">A place where people with the most diverse professional and cultural background can come and work together on creating a better world.
			</p>
			<p class="name_quote">Adebayo Okeowo</p>
		...
		<div class="recensione">
			...
			<img src="files/eiuc/marcel_home.png" alt="prima recensione" class="img_recensione">
			<img src="files/eiuc/marcel_home_mobile.jpg" alt="prima recensione" class="img_recensione img_recensione_mobile">
			<div class="text_recensione text_recensione_gc_europe">
				...
				<p class="name">Marcel Van Maastrigt</p>
				<p class="place">The Netherlands</p>
				<div class="programma_persona">
		...
		<div class="recensione">
			...
			<!-- quote latin america -->
			<div class="quote_destra quote_america_mobile z_index">
				...
				<div class="container_quote_destra">
					...
					<p class="title_quote">Diana Lorena Obagi Garcia</p>
					<p class="testo_quote_destra">Junta ejidal de Santa Cruz. Tema principal: sismo del 19 de septiembre y como ayudar al 80% de las familias que han perdido sus casas
					</p>
					<div class="condividi_social">
						<p>Share on</p>
						<div class="condividi_social_icone">
			...
			<div class="text_recensione text_recensione_gc_latin_america">
				<svg version="1.1" class="virgolette" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
					 width="11.621px" height="9.414px" viewBox="0 0 11.621 9.414" enable-background="new 0 0 11.621 9.414" xml:space="preserve">
				<path class="virgolette_bianche" fill="#75716E" d="M0.947,3.203C0.316,4.505,0,5.82,0,7.148v2.266h3.594V6.758C3.633,4.844,4.258,3.06,5.469,1.406L3.398,0
					C2.396,0.833,1.579,1.901,0.947,3.203z M7.1,3.203C6.468,4.505,6.152,5.82,6.152,7.148v2.266h3.594V6.758
				...
				<p class="name">Diana Lorena Obagi Garcia</p>
				<p class="place">Colombia</p>
				<div class="programma_persona">
					<svg version="1.1" class="icona_programma_persona" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
						 width="45.465px" height="45.128px" viewBox="0 0 45.465 45.128" enable-background="new 0 0 45.465 45.128" xml:space="preserve">
					<g>
						...
						<path clip-path="url(#SVGID_2_)" class="icona_gc" fill="#BE97C6" d="M22.733,0.6c-3.618,0-6.927,1.325-9.467,3.516
					...
					<p class="title_programma_persona titolo_gc_latin_america">GC Latin America - Caribbean</p>
				</div>
				<svg version="1.1" class="piu" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
					 width="17.432px" height="17.432px" viewBox="0 0 17.432 17.432" enable-background="new 0 0 17.432 17.432" xml:space="preserve">
				<path class="piu_bianco" fill="#717071" d="M16.443,7.728H9.704V0.989C9.704,0.443,9.262,0,8.716,0S7.728,0.443,7.728,0.989v6.739H0.989
			...
			<img src="files/eiuc/diana.png" alt="terza recensione" class="img_recensione">
			<img src="files/eiuc/diana_mobile.jpg" alt="terza recensione" class="img_recensione img_recensione_mobile">
	...
	<div class="recensione_verticale">
		...
		<div class="quote_destra quote_arab z_index">
			...
			<div class="container_quote_destra">
				<img src="files/eiuc/haneen_preview.jpg" alt="segnaposto video" class="video">
				<p class="title_quote">Haneen Mraiyan</p>
		...
		<!-- quote latin america -->
		<div class="quote_destra quote_america z_index">
			<img src="files/eiuc/x.svg" alt="bottone chiusura" class="chiudi">
			<div class="container_quote_destra">
				<img src="files/eiuc/andrea_pic.jpg" alt="segnaposto video" class="video">
				<p class="title_quote">Diana Lorena Obagi Garcia</p>
				<p class="testo_quote_destra">Junta ejidal de Santa Cruz. Tema principal: sismo del 19 de septiembre y como ayudar al 80% de las familias que han perdido sus casas.</p>
				<div class="condividi_social">
					<p>Share on</p>
					<div class="condividi_social_icone">
						<a href="javascript:void(0);">
		...
		<div class="quote_destra quote_africa z_index">
			<img src="files/eiuc/x.svg" alt="bottone chiusura" class="chiudi">
			<div class="container_quote_destra">
				<img src="files/eiuc/adebayo_pic.jpg" alt="segnaposto video" class="video">
				<p class="title_quote">Adebayo's Experience</p>
				<p class="testo_quote_destra">Adebayo Okeowo is the founder of <a href="http://www.whitecodecentre.org/" class="titolo_gc_africa" target="_blank">White Code Centre</a>, an organisation that creatively uses pictures, videos and multimedia tools to inspire social change and educate around issues of human rights.
				</p>
				<div class="condividi_social">
					<p>Share on</p>
					<div class="condividi_social_icone">
		...
		<div class="recensione">
			...
			<div class="quote_destra quote_arab_mobile z_index">
				...
				<div class="container_quote_destra">
					...
					<p class="title_quote">Haneen Mraiyan interview</p>
			...
			<img src="files/eiuc/haneen_new.png" alt="seconda recensione" class="img_recensione">
			<img src="files/eiuc/haneen_mobile_new.jpg" alt="seconda recensione" class="img_recensione img_recensione_mobile">
			<div class="text_recensione text_recensione_gc_arab">
				...
				<p class="name">Haneen Mraiyan</p>
				<p class="place">Jordan</p>
				<div class="programma_persona">
					<svg version="1.1" class="icona_programma_persona" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
						 width="45.465px" height="45.128px" viewBox="0 0 45.465 45.128" enable-background="new 0 0 45.465 45.128" xml:space="preserve">
					<g>
						...
						<path clip-path="url(#SVGID_2_)" class="icona_gc" fill="#F18D22" d="M40.336,27.052c-0.58-2.786-1.96-5.278-3.888-7.227Image may contain: 1 person, outdoor and closeup
		...
		<div class="recensione">
			...
			<div class="quote_destra quote_africa_mobile z_index">
				<img src="files/eiuc/x.svg" alt="bottone chiusura" class="chiudi chiudi_quote_africa_mobile">
				<div class="container_quote_destra">
					<img src="files/eiuc/adebayo_pic.jpg" alt="segnaposto video" class="video">
					<p class="title_quote">My Experience</p>
					<p class="testo_quote_destra"> Adebayo Okeowo is the founder of <a href="http://www.whitecodecentre.org/" class="titolo_gc_africa">White Code Centre</a>, an organisation that creatively uses pictures, videos and multimedia tools to inspire social change and educate around issues of human rights.
					</p>
					<div class="condividi_social">
						<p>Share on</p>
						<div class="condividi_social_icone">
		...
		<path clip-path="url(#SVGID_2_)" class="icona_gc" fill="#706F6F" d="M45.465,24.752c0-2.325-0.522-4.55-1.535-6.624
			...
			<img src="files/eiuc/adebayo.png" alt="quarta recensione" class="img_recensione">
			<img src="files/eiuc/adebayo_mobile.jpg" alt="quarta recensione" class="img_recensione img_recensione_mobile">
		</div>
