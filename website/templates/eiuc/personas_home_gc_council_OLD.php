...
.linkbianco {
	...
	<div class="recensione_verticale">
		...
		<div class="quote_sinistra recensione_gc_europe quote_europe z_index">
			<img src="files/eiuc/home/gc-council/global-campus-eiuc-global-hrp-home-mobile.jpg" alt="immagine pedro gonzales" class="cerchio_img">
			<img src="files/eiuc/virgolette_bianche.svg" alt="virgolette" class="margin_bottom_20">
			<p class="testo_quote">Arts can touch the hearts and help the social change we urgently need
			</p>
			<p class="name_quote">Patrizia Spinetta</p>
			<p class="margin_bottom_20">Italy</p>
		...
		<div class="recensione">
			...
			<div class="quote_destra quote_europe_mobile z_index">
				...
				<div class="container_quote_destra">
					<img src="files/eiuc/home/gc-council/global-campus-eiuc-global-hrp-home-mobile.jpg" alt="segnaposto video" class="video">
					<p class="title_quote">Patrizia Spinetta</p>
			...
			<img src="files/eiuc/home/gc-council/global-campus-eiuc-global-hrp-home.png" alt="Human Rights Pavilion" class="img_recensione">
			<img src="files/eiuc/home/gc-council/global-campus-eiuc-global-hrp-home-mobile.jpg" alt="Human Rights Pavilion" class="img_recensione img_recensione_mobile">
			<div class="text_recensione text_recensione_gc_europe">
				...
				<p class="quotes">
					Arts can touch the hearts and help the social change we urgently need
				</p>
				<p class="name">Patrizia Spinetta</p>
	...
	<div class="recensione_verticale">
		...
		<div class="quote_destra quote_europe z_index">
			...
			<div class="container_quote_destra">
				<img src="files/eiuc/home/gc-council/hrp-home.jpg" alt="segnaposto video" class="video">
				<p class="title_quote">First Human Rights Pavilion</p>
				<p class="testo_quote_destra">Art can only flourish in an atmosphere of freedom from fear, violence and repression. The universal language of arts is the most powerful and joyful medium to promote the universal values of human rights.<br><br>
					<a href="https://www.indiegogo.com/projects/human-rights-pavilion-venice-art-with-a-cause#/" class="titolo_gc_europe" target="_blank">Support Our Project</a>
				</p>
				<div class="condividi_social">
					<p>Share on</p>
					<div class="condividi_social_icone">
