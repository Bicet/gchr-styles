	...
	<div class="recensione_verticale">
		...
		<div class="quote_sinistra recensione_gc_arab quote_arab z_index">
			<img src="files/eiuc/haneen2.png" alt="Haneen Mraiyan" class="cerchio_img">
			<img src="files/eiuc/virgolette_bianche.svg" alt="virgolette" class="margin_bottom_20">
		...
		<div class="quote_sinistra recensione_gc_south_east_europe quote_south_east_europe z_index">
			<img src="files/eiuc/tara2.png" alt="immagine pedro gonzales" class="cerchio_img">
			<img src="files/eiuc/virgolette_bianche.svg" alt="virgolette" class="margin_bottom_20">
			<p class="testo_quote">A place where people with the most diverse professional and cultural background can come and work together on creating a better world.
			</p>
			<p class="name_quote">Tara Kalaputi</p>
			<p class="margin_bottom_20">Macedonia</p>
			<div class="programma_persona">
				<img src="files/eiuc/icona_gc_south_east_europe_bianca.svg" alt="icona gc latin america" class="icona_programma_persona">
				<p class="title_programma_persona ">GC South East Europe</p>
			</div>
		</div>
		...
		<div class="recensione">
			...
			<div class="quote_destra quote_south_east_europe_mobile z_index">
				...
				<div class="container_quote_destra">
					...
					<p class="title_quote">Tara Kalaputi</p>
			...
			<div class="text_recensione text_recensione_gc_south_east_europe">
				...
				<p class="name">Tara Kalaputi</p>
				<p class="place">Macedonia</p>
				<div class="programma_persona">
					<svg version="1.1" class="icona_programma_persona" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
						 width="45.465px" height="45.128px" viewBox="0 0 45.465 45.128" enable-background="new 0 0 45.465 45.128" xml:space="preserve">
					<g>
		...
		<path  class="icona_gc" fill="#69C8F3" d="M176.818,28.063c2.193,0,3.649,1.393,3.649,3.81v0.576h-5.746
			...
			<img src="files/eiuc/tara2.png" alt="terza recensione" class="img_recensione">
			<img src="files/eiuc/tara_mobile.jpg" alt="terza recensione" class="img_recensione img_recensione_mobile">
	...
	<div class="recensione_verticale">
		...
		<div class="recensione">
			...
			<img src="files/eiuc/haneen2.png" alt="seconda recensione" class="img_recensione">
...
c5.8,0,10.803-3.405,13.124-8.325c0.884-1.874,1.38-3.968,1.38-6.178C40.642,29.006,40.536,28.012,40.336,27.052"></path>						<path clip-path="url(#SVGID_2_)" class="icona_gc" fill="#706F6F" d="M45.465,24.753c0-2.325-0.522-4.55-1.536-6.624
