        ...
        <div class="list_accordion">
            ...
            <div class="riga">
                <div class="tweet2">
                    ...
                    <br>
                    <p id="ip303">Learn about the interconnection and interdependence between history, memory, art and human rights and the influence of memory sites in shaping communities, identities, societies and nations in this #GCHumanRights #MOOC: gchumanrights.org/mshr<br><br>#HumanRights #HumanRightsEducation #Democratisation<br>@gchumanrights
                    </p><br><br><br><br><br>
